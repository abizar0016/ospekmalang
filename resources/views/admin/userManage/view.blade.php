...
<div class="main">
    ...
    <div class="button-group">
        ...
        <a href="" class="btn update-btn">Perbarui</a>
        <form action="{{ route('admin.user.delete', $user->id) }}" method="POST" class="delete-form" onsubmit="return confirm('Are you sure you want to delete this user?');">
            @csrf
            @method('DELETE')
